...
function ProtectedRoute({ children }) {
  ...
  const adminMenu = [
    ...
    {
      title: "Students",
      paths: ["/admin/reports/student"],
      icon: <i className="ri-file-list-line"></i>,
      onClick: () => navigate("/admin/reports/student"),
    },
    {
      title: "Logout",
      paths: ["/logout"],
      ...
      <div className="flex gap-2 w-full h-full h-100">
        ...
        <div className="body">
          <div className="header flex justify-between">
            ...
            <h1 className="text-2xl text-white">Score More</h1>
            <div>
